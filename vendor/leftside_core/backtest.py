...
SNAPSHOT_DATA_DATE_FIX = {
    "ashare": {
        ...
        # 跑批挪到 10:00 CEST 的首日 (2026-09-14 卡 DATA-DATE): 个股 10:01 已入库到 09-14, 指数表要等
        # 跑完才补, 流水线拿基准序列末日 09-11 当了 data_date; 277 条候选价逐值 = 库内 09-14 收盘
        # (审计计数见 CHRONICLE 09-14 段)。服务器副本已就地改正 (meta.data_date_corrected 留痕),
        # 这一条是给任何还带着 09-11 的副本 (备份恢复 / 手工拷贝) 读到时自动修。
        "day_2026-09-14.json": ("2026-09-11", "2026-09-14"),
    },
    "us": {},
}
